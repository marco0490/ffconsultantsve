...
import OceanicaLogo from '../../assets/images/OceanicaLogo.png'
import { Helmet } from 'react-helmet'
import { Link } from 'react-router-dom'

function PlansOceanica() {
  ...
  return (
    <div id="Oceanica" className="md:my-18 flex flex-col">
      <Helmet>
      ...
      <div className="w-full px-4 bg-white flex flex-col">
        ...
        <div className="min-w-[280px] mx-auto grid md:grid-cols-3 gap-8 md:mt-12 md:mb-6">
          <div className="w-full shadow-xl border border-gray-200 flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
            ...
            <Link to='/cotizador?aseguradora=seguros-oceanica&producto=auto'>
          ...
          <div className="w-full shadow-xl border border-gray-200 flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
            ...
            <div className="text-center font-semibold mt-4 border-t-2 border-gray-200"></div>
            <Link to='/cotizador?aseguradora=seguros-oceanica&producto=personas'>
          ...
          <div className="w-full shadow-xl border border-gray-200 flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
            ...
            <div className="text-center font-semibold mt-4 border-t-2 border-gray-200"></div>
            <Link to='/cotizador?aseguradora=seguros-oceanica&producto=patrimoniales'>
              <button className="text-black w-[200px] border-solid border-2 border-[#efefef] font-bold my-10 mx-auto py-3 bg-white hover:bg-primary hover:text-white">
                Cotiza este Plan
              </button>
            </Link>
        ...
        <div className="md:m-auto pb-12 max-w-[800px]">
          <p>
            <strong>Una historia joven y optimista que se inicia en el año 1999 como el Grupo Asegurador Previsional,</strong>{' '}
            C.A. (GRASP) para ofrecer servicios en los Seguros de Personas.
Siete años después, con rumbo seguro a su consolidación en el mercado, se convierte en Oceánica de Seguros C.A., y en el 2009, incrementa su capital logrando la aprobación para operar en todos los Seguros. Hoy, son una de las primeras diez (10) empresas aseguradoras del mercado nacional y se enfocan en acentuar la presencia regional, captar la mejor fuerza de ventas y ampliar su gama de servicios y productos:
          </p>
