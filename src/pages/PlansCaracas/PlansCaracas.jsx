...
function PlansCaracas() {
  ...
  return (
    <div id="Caracas" className="md:my-18 flex flex-col">
      <Helmet>
        <title>Planes Seguros Caracas</title>
        <meta name="title" content="Planes Seguros Caracas" />
        <meta
          name="description"
          content="Opciones de planes con Seguros Caracas para todo tipo de clientes. Aquí encontrarás lo que necesitas!"
        />
      </Helmet>
      ...
      <div className="w-full px-4 bg-white flex flex-col">
        ...
        <div className="md:m-auto pb-12 max-w-[800px]">
          <p>
            <strong>Seguros Caracas es una de las aseguradoras más tradicionales de Venezuela,</strong>{' '}
            con décadas de experiencia brindando protección y tranquilidad a familias y empresas.
