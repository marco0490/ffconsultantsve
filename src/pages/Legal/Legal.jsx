  ...
  return (
    <div className=" md:m-auto mb-5 mx-5 md:mt-[5rem] max-w-[800px] pt-7 lg:mt-[6rem] space-y-2">
      ...
      <p>
        ...
        seguros de salud, entre otros productos debidamente autorizados por la
        Superintendencia y los entes que se requieran de la Actividad
        Aseguradora del mercado Venezolano. Nuestro servicio es totalmente
        gratuito en esta primera fase V-1.0 y está orientado a intermediar entre
        los intermediarios las pólizas de seguro que usted adquiera a través de
        nuestro sitio web.
      </p>
      ...
      <p>
        ...
        para su propio uso pero no como negocio, que desean obtener y comparar
      ...
      <p>
        ...
        cuestionario, así como información sobre las características de los
        seguros ofrecidos por los diferentes compañías. También le
        proporcionamos la posibilidad de contratar directamente el seguro en las
      ...
      <p>
        ...
        la cotización, pero debe tener presente que los precios de las pólizas
        pueden variar después de la fecha de la cotización. Por ello, debe
      ...
      <p>
        ...
        plazos de validez de la oferta que usted podrá observar en el cuadro
        comparativo.
      </p>
      ...
      <ul className="list-disc list-inside">
        <li>
          Aceptación: Para obtener nuestro servicio, debe aceptar las
          condiciones de los acuerdo y el contenido del Aviso Legal, Política de
          Privacidad y Política de Prevención y Legitimación de Capitales. Esto
          aplica tanto para nuestro servicio como los contratos que se manejen
          con nosotros.
        </li>
        <li>
          Idioma, legislación y jurisdicción: El presente acuerdo se cumplirá en
          idioma español, se rige por la legislación venezolana y está sujeto a
          la jurisdicción de los tribunales venezolanos.
        </li>
        <li>
          Responsabilidad: Usted es responsable de la veracidad de las
          respuestas dadas en el cuestionario, y si los datos no son suyos o el
          ...
          suscriba con el asegurador, ni de problemas o quejas que puedan surgir
          en su relación con el mismo. Las páginas web con las que puede
          conectar desde la nuestra son propiedad y están gestionadas por
          entidades ajenas a nosotros; no somos responsables de su
          funcionamiento, contenido, ni de productos o servicios obtenidos de
          ellas o a través de las mismas. No nos hacemos cargo de eventuales
          daños que sean responsabilidad del cliente por manipular o usar esta
          página web de forma indebida.
        </li>
      </ul>
      ...
      <p>
        ...
        los comparativos de costos vía web: Luego de recibir sus instrucciones
        escritas, nos encargaremos de seguir el cumplimiento de su póliza de
        seguro. Durante la contratación de su(s) póliza(s), les mantendremos
        informados del desarrollo de las negociaciones y de cualquier
        eventualidad que pudiera surgir para obtener la cobertura que requiere.
        Tomaremos todas las acciones razonables para estructurar su programa de
        seguros, según la disposición de los aseguradores, antes de la fecha de
        inicio de la vigencia, renovación o extensión de cobertura (según sea el
      ...
      <p>
        ...
        garantizar el cumplimiento de los contratos de las pólizas. Algunos KPIs
        que podrían ser útiles son la tasa de conversión, el tiempo promedio en
        el sitio web, el costo por adquisición (CPA), la tasa de rebote y el
        porcentaje de renovación. Además, se evalúa la solidez económica y
        financiera de las aseguradoras que se presentan mediante el uso de
        información pública, incluyendo aquella generada y elaborada por
        agencias reconocidas. Bajo ninguna circunstancia se actúa como
        aseguradores ni se garantiza la solvencia de un asegurador que se
        utilice para colocar su programa de seguros. Por ende, la decisión
        referente a la confianza o garantía de cualquier asegurador recae sobre
        el usuario. Si tuviera dudas acerca del asegurador seleccionado para sus
        necesidades de seguro, debe notificarlo de inmediato con el fin de
        resolverlas. En caso de requerirlo, se pondrá a su disposición el
      ...
      <p>
        ...
        financiera con información pública y fiable, proveniente de agencias
        reconocidas. Así, te aseguramos que tu póliza estará respaldada por
        empresas solventes y profesionales.
      </p>
      ...
      <p>
        ...
        nuestros canales online disponibles. También te enviaremos de forma
        digital el Condicionado de la Póliza y cualquier cambio o anexo que se
        produzca lo antes posible. Si prefieres gestionar el siniestro
      ...
      <p>
        ...
        documentación que confirma la cobertura que hemos contratado en tu
        nombre, incluyendo los detalles de los aseguradores y el recibo de prima
        con el desglose del monto a pagar. También te informaremos de la fecha
        límite de pago y las consecuencias de un posible retraso o falta del
        mismo.
      </p>
      ...
      <p>
        ...
        nuestro portal de autogestión, no nos hacemos responsables de las
        consecuencias que puedan derivarse. Si tiene alguna duda sobre qué
      ...
      <p>
        ...
        procedimientos relacionados con los siniestros y la fecha de
        notificación de los mismos. Usted como asegurado es responsable de
        notificar las reclamaciones, siniestros o circunstancias potenciales que
        pudieran dar lugar a estos hechos de forma inmediata. Cuando se presente
        el aviso de siniestro o de los hechos que puedan dar lugar a una
        reclamación, es su responsabilidad informar adecuadamente y con la
      ...
      <p>
        ...
        cláusulas, amparos y coberturas contratadas, límites, deducibles y demás
        términos del contrato de seguro. Le recomendamos hacer énfasis en las
        condiciones y garantías de todas las pólizas, ya que el no cumplirlas
        pudiera anular su cobertura. Además, lea detenidamente las disposiciones
        referidas a los plazos para la notificación de siniestros y presentación
        de documentos. En caso de discrepancias o dudas al respecto, es
        necesario que nos consulte inmediatamente.
      </p>
      ...
      <ul className="list-decimal list-inside">
        <li>El material no puede ser usado para propósitos comerciales. </li>
        <li>
          La copia debe retener cualquier copyright o otros avisos contenidos en
          el material original.
        </li>
        <li>
          La tecnología y procesos utilizados o descritos en este sitio web
          pueden estar sujetos a otros derechos de propiedad intelectual
          reservados por futurefinancialconsultantsve.com (vea el apartado
      ...
      <p>
        ...
        prestar el servicio, pertenecen a esas sociedades y no pueden
        reproducirse sin su consentimiento previo. Todos los restantes derechos
        de propiedad intelectual o industrial sobre cualquier información,
        contenido, datos o procesos contenidos en o subyacentes a esta web o al
        servicio que prestamos pertenecen a Future Financial Consultants CA.
        Todos los derechos de futurefinancialconsultanstve.com de tal propiedad
      ...
      <p>
        ...
        información, tanto los datos personales como los datos de transacción,
        es encriptada antes de ser transmitida y otros tipo de servicios mas
        avanzados. Como medida adicional de seguridad, nuestra web cuenta con
        todos los certificado de identificación digital. El objetivo de las
        fuertes medidas de seguridad que adoptamos es salvaguardar su privacidad
        de accesos no autorizados o de un uso inapropiado. Además, seguiremos
        implementando nueva tecnología para aumentar la seguridad, según esté
        disponible.
      </p>
      ...
      <p>
        ...
        Financial Consultants CA dirigido por Oliver Sierra Corredor de Seguros
        y Analista de Riesgo y el equipo TI de futurefinancialconsultantsve.com,
        debidamente registrado ante la Superintendencia de la Actividad
        Aseguradora, bajo el código No 4171 domiciliada en, la Av. Francisco de
        Miranda, Torre Cavendes, piso 9, oficina 901, Caracas, Venezuela, con la
        finalidad de obtener presupuestos de las compañías de seguros por medio
      ...
      <p>
        ...
        cotización, así como para la realización de estudios estadísticos, el
        envío de boletines informativos generalistas, ofertas y/o promociones
        comerciales adecuadas a su perfil particular y la categoría de producto
      ...
      <p>
        ...
        condiciones legales implicará la declaración del usuario de que es mayor
        de 18 años.
      </p>
      ...
      <p>
        ...
        también se conoce como lavado o blanqueo de dinero o activos. Nuestro
        legislador usó el término Legitimación de Capitales por ser más preciso
        y amplio jurídicamente. Existen varias formas en las que se puede usar
        el mercado asegurador para fines de legitimación de capitales, pero lo
        importante es saber identificarlas y reportarlas. Para detectar
        operaciones o transacciones sospechosas que no tengan una justificación
        lógica, la Superintendencia de Seguros ha creado un formulario online
        para Reportar Actividades Sospechosas del Sector Seguros. Este
        formulario permite registrar la información detallada sobre las personas
        naturales o jurídicas involucradas en dichas operaciones. Esta
        información será analizada cuidadosamente por la Superintendencia de
        Seguros y se tomarán las acciones correspondientes. Las personas
        naturales y jurídicas del Sector Asegurador deben cumplir con las normas
        y pautas establecidas por los organismos reguladores para prevenir y
        controlar estos delitos. Esto implica adoptar medidas adecuadas y
        suficientes para evitar que se usen los servicios o productos del sector
        asegurador como medios para esconder, manejar, invertir o beneficiarse
      ...
      <p>
        ...
        situación como una actividad sospechosa a la Unidad de Prevención y
        Control de la Legitimación de la LC/FT de la Superintendencia de la
      ...
      <p>
        ...
        ordenador cuando los visita y actúa como un identificador que puede
        usarse para recuperar sus datos en las bases de datos y para seguir su
        navegación dentro de la web. Nosotros usamos cookies para ayudarlo a
        navegar en nuestra web, facilitar el seguimiento del servicio con el
        asegurador y mejorar su seguridad. Si no desea tener una de nuestras
        cookies en su ordenador, por favor asegúrese de que su buscador está
        configurado para bloquearlas. Puede utilizar nuestra web aún si bloquea
        las cookies.
      </p>
      ...
      <p>
        ...
        utilizadas son almacenadas en el disco duro del usuario pero no pueden
        leer los datos contenidos en él ni leer los archivos cookies creados por
        otros proveedores. No se recogerá ningún dato de carácter personal a
      ...
      <p>
        ...
        prestar un mejor servicio a los usuarios. Pueden, por ejemplo, recordar
        sus preferencias, sus elecciones, ayudarnos a saber la forma en la que
        utiliza nuestras páginas web y adaptar el contenido que se muestra para
        que le resulte más útil en función de sus intereses y necesidades.
      ...
      <p>
        ...
        el servidor para guardar/recordar información acerca de las actividades
      ...
      <p>
        ...
        pueden ser utilizadas para rastrear visitas al sitio web y para
        controlar cómo las personas interactúan con un sitio web. Las cookies
        persistentes utilizadas por FUTUREFINANCIALCONSULTANTSVE.COM nos
      ...
      <p>
        ...
        a mejorar la estructura del sitio. Ni nosotros ni ningún tercero
        podremos identificarle personalmente de esta manera.
      </p>
      ...
      <p>
        ...
        permiten aceptar o rechazar todas las cookies, aceptar sólo determinadas
        cookies o hacer que se le pregunte cada vez que una página web quiere
        guardar una cookie. Además, puede eliminar las cookies que el navegador
        ya ha guardado en su equipo. Los procesos para controlar y eliminar
        cookies varían dependiendo del navegador que utilice. Para informarse de
        cómo hacerlo en un determinado navegador, puede utilizar la función de
        Ayuda del mismo.
      </p>
      ...
      <p>
        ...
        cookies utilizadas son almacenadas en el disco duro del usuario pero no
        pueden leer los datos contenidos en él ni leer los archivos cookies
      ...
      <p>
        ...
        navegador. Pueden habilitar ciertas funcionalidades del sitio y también
        son utilizadas por el servidor para guardar/recordar información acerca
        de las actividades del usuario; por ejemplo, a través de un proceso
        online web para evitar tener que volver a introducir la información. Las
        cookies de sesión que utilizamos son estrictamente necesarias para que
        futurefinancialconsultantsve.com pueda funcionar correctamente,
        incluyendo la obtención de un presupuesto o para proteger la seguridad
        de nuestros clientes. Las cookies persistentes permanecen en el archivo
        de cookies del navegador durante más tiempo (el tiempo varía según la
        cookie). Estas cookies pueden ser utilizadas para recordar información
        específica sobre el usuario, como sus preferencias o elecciones, y
        pueden ser utilizadas para adaptar el contenido mostrado a los intereses
