...
function PlansEstar() {
  ...
  return (
    <div id="Estar" className="md:my-18 flex flex-col">
      <Helmet>
        <title>Planes Estar Seguros</title>
        <meta name="title" content="Planes Estar Seguros" />
        <meta
          name="description"
          content="Opciones de planes con Estar Seguros para todo tipo de clientes. Aquí encontrarás lo que necesitas!"
        />
      </Helmet>
      ...
      <div className="w-full px-4 bg-white flex flex-col">
        ...
        <div className="min-w-[280px] mx-auto grid md:grid-cols-3 gap-8 md:mt-12 md:mb-6">
          ...
          <div className="w-full shadow-xl border border-gray-200 flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
            ...
            <p className="text-center text-4xl font-bold">
              <span className="text-lg align-top">$</span>33
            </p>
          ...
          <div className="w-full shadow-xl border border-gray-200 flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
            ...
            <p className="text-center text-4xl font-bold">
              <span className="text-lg align-top">$</span>5,000
            </p>
            <h2 className="text-center text-primary font-semibold mt-2">
              Vida
            </h2>
        ...
        <div className="md:m-auto pb-12 max-w-[800px]">
          <p>
            <strong>Estar Seguros es una compañía aseguradora venezolana moderna,</strong>{' '}
            enfocada en ofrecer soluciones de protección accesibles y confiables.
