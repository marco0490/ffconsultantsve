...
function Howto() {
  return (
    ...
    <h2 className="md:text-4xl text-xl py-12 font-bold text-primary max-w-[700px] text-center md:pt-28 px-4">¿Cómo puedes cotizar en línea tu póliza de seguro de salud?</h2>
      </div>
      <div className='grid md:px-32 grid-cols-1 sm:grid-cols-2 gap-8 text-center md:m-0 mx-2 '>
        ...
        <div className="block">
          ...
          <img src={Ellipse2} alt="" className="hidden md:block md:absolute md:-top-6 md:-left-14"/>
          <img src={Ellipse1} alt="" className="hidden md:block md:absolute md:top-8"/>
